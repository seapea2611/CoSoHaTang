...
using Asd.Hrm.MultiTenancy.HostDashboard;
...
namespace Asd.Hrm.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(HrmDbContext context, SubscriptionPayment subscriptionPayment)
        {
