...
{
    public class SessionAppService : HrmAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = HrmConsts.Currency,
                        CurrencySign = HrmConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = HrmConsts.AllowTenantsToChangeEmailSettings,
