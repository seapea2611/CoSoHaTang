...
namespace Asd.Hrm.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : HrmAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<HrmDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{HrmConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{HrmConsts.ConnectionStringName}", constring);
        }
