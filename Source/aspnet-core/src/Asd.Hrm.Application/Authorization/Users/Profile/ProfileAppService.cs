...
using Asd.Hrm.Authorization.Users.Profile.Cache;
...
using Asd.Hrm.Timing;

namespace Asd.Hrm.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : HrmAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Asd.Hrm",
