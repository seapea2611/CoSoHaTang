...
using Asd.Hrm.Configuration.Tenants.Dto;
using Asd.Hrm.Security;
using Asd.Hrm.Storage;
using Asd.Hrm.Timing;

namespace Asd.Hrm.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !HrmConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
