...
namespace Asd.Hrm.Web.Public.Startup
{
    [DependsOn(
        typeof(HrmWebCoreModule)
    )]
    public class HrmWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public HrmWebFrontEndModule(IWebHostEnvironment env, HrmEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HrmWebFrontEndModule).GetAssembly());
        }
    }
}
