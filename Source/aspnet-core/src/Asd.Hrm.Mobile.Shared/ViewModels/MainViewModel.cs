...
using Asd.Hrm.Controls;
using Asd.Hrm.Dto;
using Asd.Hrm.Extensions;
using Asd.Hrm.Localization;
using Asd.Hrm.UI;
using Asd.Hrm.UI.Assets;
using Asd.Hrm.Views;
using DependencyResolver = Asd.Hrm.Core.Dependency.DependencyResolver;
