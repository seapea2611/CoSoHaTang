...
{
    public class SubscriptionPaymentRepository : HrmRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<HrmDbContext> dbContextProvider)
