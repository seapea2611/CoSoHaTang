...
using Asd.Hrm.Core.Base;
using Asd.Hrm.Core.Extensions;
using Asd.Hrm.Dto;
using Asd.Hrm.Types;

namespace Asd.Hrm.Queries
{
    public class OrganizationUnitQuery : HrmQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
