...
namespace Asd.Hrm.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : HrmServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Asd.Hrm", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
