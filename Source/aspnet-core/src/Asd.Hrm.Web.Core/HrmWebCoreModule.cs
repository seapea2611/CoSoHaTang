...
using Asd.Hrm.Authentication.TwoFactor;
using Asd.Hrm.Chat;
using Asd.Hrm.Configuration;
using Asd.Hrm.EntityFrameworkCore;
using Asd.Hrm.Startup;
using Asd.Hrm.Web.Authentication.JwtBearer;
using Asd.Hrm.Web.Authentication.TwoFactor;
using Asd.Hrm.Web.Chat.SignalR;
using Asd.Hrm.Web.Common;
using Asd.Hrm.Web.Configuration;
using Asd.Hrm.Web.DashboardCustomization;

namespace Asd.Hrm.Web
{
    [DependsOn(
    ...
    public class HrmWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public HrmWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(HrmApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HrmWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(HrmWebCoreModule).Assembly);
        }
