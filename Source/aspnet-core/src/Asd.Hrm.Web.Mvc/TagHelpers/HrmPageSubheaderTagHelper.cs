...
namespace Asd.Hrm.Web.TagHelpers
{
    ...
    public class HrmPageSubheaderTagHelper : TagHelper
    {
        ...
        public HrmPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
