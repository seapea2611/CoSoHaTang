...
using Asd.Hrm.Authorization.Permissions;
...
using Asd.Hrm.Web.Areas.App.Models.Roles;
using Asd.Hrm.Web.Areas.App.Models.Users;
...
namespace Asd.Hrm.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class UsersController : HrmControllerBase
    {
