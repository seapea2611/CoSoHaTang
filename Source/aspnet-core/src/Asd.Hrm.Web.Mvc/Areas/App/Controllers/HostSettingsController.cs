...
using Asd.Hrm.Configuration.Host;
using Asd.Hrm.Editions;
using Asd.Hrm.Timing;
using Asd.Hrm.Timing.Dto;
using Asd.Hrm.Web.Areas.App.Models.HostSettings;
...
namespace Asd.Hrm.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : HrmControllerBase
    {
