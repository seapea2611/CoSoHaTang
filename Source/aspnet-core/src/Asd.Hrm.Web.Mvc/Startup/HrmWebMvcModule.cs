...
namespace Asd.Hrm.Web.Startup
{
    ...
    public class HrmWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public HrmWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HrmWebMvcModule).GetAssembly());
        }
