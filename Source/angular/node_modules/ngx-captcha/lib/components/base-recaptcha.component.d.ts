...
export declare abstract class BaseReCaptchaComponent implements OnChanges, ControlValueAccessor, AfterViewInit, AfterViewChecked {
    ...
    */
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<BaseReCaptchaComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<BaseReCaptchaComponent, never, never, { "useGlobalDomain": "useGlobalDomain"; "type": "type"; "tabIndex": "tabIndex"; "siteKey": "siteKey"; "hl": "hl"; }, { "success": "success"; "load": "load"; "reset": "reset"; "ready": "ready"; "error": "error"; "expire": "expire"; }, never>;
}
