(function (global, factory) {
    ...
    var GridsterCompact = /** @class */ (function () {
        ...
        GridsterCompact.prototype.checkCompact = function () {
            if (this.gridster.$options.compactType !== exports.CompactType.None) {
                ...
                else if (this.gridster.$options.compactType === exports.CompactType.CompactDown) {
                    this.checkCompactMovement('y', 1);
                }
                else if (this.gridster.$options.compactType === exports.CompactType.CompactDownAndLeft) {
                    this.checkCompactMovement('y', 1);
                    this.checkCompactMovement('x', -1);
                }
                else if (this.gridster.$options.compactType === exports.CompactType.CompactDownAndRight) {
                    this.checkCompactMovement('y', 1);
                    this.checkCompactMovement('x', 1);
                }
                else if (this.gridster.$options.compactType === exports.CompactType.CompactLeftAndDown) {
                    this.checkCompactMovement('x', -1);
                    this.checkCompactMovement('y', 1);
                }
                else if (this.gridster.$options.compactType === exports.CompactType.CompactRightAndDown) {
                    this.checkCompactMovement('x', 1);
                    this.checkCompactMovement('y', 1);
                }
            }
        ...
        GridsterCompact.prototype.checkCompactMovement = function (direction, delta) {
            var _this = this;
            var widgetMoved = false;
            this.gridster.grid.forEach(function (widget) {
                if (widget.$item.compactEnabled !== false) {
                    var moved = _this.moveTillCollision(widget.$item, direction, delta);
                    if (moved) {
                        widgetMoved = true;
        ...
        GridsterCompact.prototype.moveTillCollision = function (item, direction, delta) {
    ...
    var GridsterConfigService = {
        ...
        dirType: exports.DirTypes.LTR, // page direction, rtl=right to left ltr= left to right, if you use rtl language set dirType to rtl
    };
    ...
    var GridsterRenderer = /** @class */ (function () {
        ...
        GridsterRenderer.prototype.updateGridster = function () {
            ...
            if (this.gridster.$options.gridType === exports.GridType.Fit) {
                ...
                var widthRatio = this.gridster.$options.rowHeightRatio;
                var calWidthRatio = widthRatio >= 1 ? widthRatio : widthRatio + 1;
    ...
    var GridsterPreviewComponent = /** @class */ (function () {
        function GridsterPreviewComponent(el, renderer) {
            this.renderer = renderer;
            this.el = el.nativeElement;
        }
        GridsterPreviewComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.sub = this.previewStyle$.subscribe(function (options) { return _this.previewStyle(options); });
        };
        ...
        GridsterPreviewComponent.prototype.previewStyle = function (item) {
            if (item) {
    ...
    GridsterPreviewComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterPreviewComponent, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }], target: i0__namespace.ɵɵFactoryTarget.Component });
    GridsterPreviewComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.0.3", type: GridsterPreviewComponent, selector: "gridster-preview", inputs: { previewStyle$: "previewStyle$", gridRenderer: "gridRenderer" }, ngImport: i0__namespace, template: '', isInline: true, styles: ["gridster-preview{position:absolute;display:none;background:#00000026}"], encapsulation: i0__namespace.ViewEncapsulation.None });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterPreviewComponent, decorators: [{
                type: i0.Component,
                args: [{
    ...
    var GridsterComponent = /** @class */ (function () {
        function GridsterComponent(el, renderer, cdRef, zone) {
            ...
            this.gridColumns = [];
            this.gridRows = [];
            this.previewStyle$ = new i0.EventEmitter();
            this.el = el.nativeElement;
        ...
        GridsterComponent.prototype.checkCollisionForSwaping = function (item) {
            ...
            if (!collision) {
                var c = this.findItemWithItemForSwapping(item);
                if (c) {
                    collision = c;
                }
            }
        ...
        GridsterComponent.prototype.findItemWithItemForSwapping = function (item) {
            var widgetsIndex = this.grid.length - 1;
            var widget;
        ...
        GridsterComponent.prototype.previewStyle = function (drag) {
    ...
    GridsterComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterComponent, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i0.ChangeDetectorRef }, { token: i0.NgZone }], target: i0__namespace.ɵɵFactoryTarget.Component });
    GridsterComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.0.3", type: GridsterComponent, selector: "gridster", inputs: { options: "options" }, usesOnChanges: true, ngImport: i0__namespace, template: "<div class=\"gridster-column\" *ngFor=\"let column of gridColumns; let i = index;\"\n     [ngStyle]=\"gridRenderer.getGridColumnStyle(i)\"></div>\n<div class=\"gridster-row\" *ngFor=\"let row of gridRows; let i = index;\"\n     [ngStyle]=\"gridRenderer.getGridRowStyle(i)\"></div>\n<ng-content></ng-content>\n<gridster-preview [gridRenderer]=\"gridRenderer\" [previewStyle$]=\"previewStyle$\"\n                  class=\"gridster-preview\"></gridster-preview>\n", styles: ["gridster{position:relative;box-sizing:border-box;background:grey;width:100%;height:100%;-webkit-user-select:none;user-select:none;display:block}gridster.fit{overflow-x:hidden;overflow-y:hidden}gridster.scrollVertical{overflow-x:hidden;overflow-y:auto}gridster.scrollHorizontal{overflow-x:auto;overflow-y:hidden}gridster.fixed{overflow:auto}gridster.mobile{overflow-x:hidden;overflow-y:auto}gridster.mobile gridster-item{position:relative}gridster.gridSize{height:auto;width:auto}gridster.gridSize.fit{height:100%;width:100%}gridster .gridster-column,gridster .gridster-row{position:absolute;display:none;transition:.3s;box-sizing:border-box}gridster.display-grid .gridster-column,gridster.display-grid .gridster-row{display:block}gridster .gridster-column{border-left:1px solid #fff;border-right:1px solid #fff}gridster .gridster-row{border-top:1px solid #fff;border-bottom:1px solid #fff}"], components: [{ type: GridsterPreviewComponent, selector: "gridster-preview", inputs: ["previewStyle$", "gridRenderer"] }], directives: [{ type: i2__namespace.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { type: i2__namespace.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }], encapsulation: i0__namespace.ViewEncapsulation.None });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterComponent, decorators: [{
                type: i0.Component,
                args: [{
    ...
    var GridsterSwap = /** @class */ (function () {
        ...
        GridsterSwap.prototype.checkSwap = function (pushedBy) {
            ...
            if (gridsterItemCollision && gridsterItemCollision !== true && gridsterItemCollision.canBeDragged()) {
                ...
                var diffX = copyX - copyCollisionX;
                var diffY = copyY - copyCollisionY;
    ...
    var GridsterResizable = /** @class */ (function () {
        ...
        GridsterResizable.prototype.handleW = function (e) {
            var clientX = this.gridster.$options.dirType === exports.DirTypes.RTL ? this.originalClientX + (this.originalClientX - e.clientX) : e.clientX;
    ...
    var GridsterItemComponent = /** @class */ (function () {
        ...
        GridsterItemComponent.prototype.canBeDragged = function () {
            var gridDragEnabled = this.gridster.$options.draggable.enabled;
            var itemDragEnabled = this.$item.dragEnabled === undefined ? gridDragEnabled : this.$item.dragEnabled;
            return !this.gridster.mobile && gridDragEnabled && itemDragEnabled;
        };
        GridsterItemComponent.prototype.canBeResized = function () {
            var gridResizable = this.gridster.$options.resizable.enabled;
            var itemResizable = this.$item.resizeEnabled === undefined ? gridResizable : this.$item.resizeEnabled;
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterItemComponent, decorators: [{
            ...
            return [{ type: i0__namespace.ElementRef, decorators: [{
                            type: i0.Inject,
                            args: [i0.ElementRef]
                        }] }, { type: GridsterComponent }, { type: i0__namespace.Renderer2, decorators: [{
                            type: i0.Inject,
                            args: [i0.Renderer2]
                        }] }, { type: i0__namespace.NgZone, decorators: [{
                            type: i0.Inject,
    ...
    GridsterModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    GridsterModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterModule, declarations: [GridsterComponent,
            GridsterItemComponent,
            GridsterPreviewComponent], imports: [i2.CommonModule], exports: [GridsterComponent, GridsterItemComponent] });
    GridsterModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterModule, imports: [[
                i2.CommonModule
            ]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.3", ngImport: i0__namespace, type: GridsterModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        declarations: [
                            GridsterComponent,
