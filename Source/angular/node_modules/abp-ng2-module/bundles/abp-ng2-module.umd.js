(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('abp-ng2-module', ['exports', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['abp-ng2-module'] = {}, global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators));
    ...
    RefreshTokenService.decorators = [
        { type: i0.Injectable }
    ];
    ...
    var AbpHttpInterceptor = /** @class */ (function () {
        ...
        AbpHttpInterceptor.prototype.intercept = function (request, next) {
            ...
            return next.handle(modifiedRequest)
                ...
                if (error instanceof i1.HttpErrorResponse && error.status === 401) {
        ...
        AbpHttpInterceptor.prototype.normalizeRequestHeaders = function (request) {
            var modifiedHeaders = new i1.HttpHeaders();
        ...
        AbpHttpInterceptor.prototype.handleErrorResponse = function (error) {
            ...
            return this.configuration.blobToText(error.error).pipe(operators.switchMap(function (json) {
                ...
                var errorResponse = new i1.HttpResponse({
