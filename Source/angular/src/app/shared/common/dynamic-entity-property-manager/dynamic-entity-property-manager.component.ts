...
export class DynamicEntityPropertyManagerComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this._dynamicEntityProperty.getAllEntitiesHasDynamicProperty()
            .subscribe(result => {
    ...
    hasPermission(): boolean {
        return this._permissionCheckerService.isGranted('Pages.Administration.DynamicEntityProperties') && this._permissionCheckerService.isGranted('Pages.Administration.DynamicEntityPropertyValue.Edit');
    }
