import { Component, OnInit, Injector, Input, ViewChild, OnDestroy, AfterViewChecked } from '@angular/core';
...
export class CustomizableDashboardComponent extends AppComponentBase implements OnInit, OnDestroy, AfterViewChecked {
