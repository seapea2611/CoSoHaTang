...
export class LanguageTextsComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    ngOnInit(): void {
        this.sourceNames = _map(_filter(abp.localization.sources, source => source.type === 'MultiTenantLocalizationSource'), value => value.name);
    ...
    init(): void {
        this._activatedRoute.params.subscribe((params: Params) => {
            ...
            this.sourceName = params['sourceName'] || 'Hrm';
